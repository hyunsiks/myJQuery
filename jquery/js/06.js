...
$('.submit').click(function(e) {
    ...
    var fruitCount = $('#fruit option:selected').val();

    if(foodCount == 0 || fruitCount == 0){
        if(foodCount == 0){
            alert('food 셀렉트 박스를 선택하세요');
        }else if(fruitCount == 0){
            alert('fruit 셀렉트 박스를 선택하세요');
        }
    }else{
        alert(foodCount+", "+ fruitCount +" 선택되었습니다.");
